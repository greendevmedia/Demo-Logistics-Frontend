...
@Component({
  selector: 'app-edit-shipment-driver',
  templateUrl: './edit-shipment-driver.component.html',
  styleUrls: ['./edit-shipment-driver.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class EditShipmentDriverComponent implements OnInit {
